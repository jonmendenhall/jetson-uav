# This is a copy of darknet_demo.py from https://github.com/abhigarg/darknet-yolo-python
# The default darknet.py does not allow for passing numpy arrays as images, but this modified script will.
